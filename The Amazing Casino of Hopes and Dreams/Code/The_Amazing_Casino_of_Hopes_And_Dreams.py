...
def menu():
    ...
    if current_loan_repayment_value > 0:
        ...
        if gorl in ("l", "L"):
            ...
            pass
    current_game = input(
        "What shall you play today: Blackjack, Roulette, Slots, Crash, or Horse Race: ")

    if current_game in ("Blackjack", "blackjack", "b", "bj"):
        print("")
    ...
    if current_game in ("Roulette", "roulette", "r", "R"):
        print("")
    ...
    if current_game in ("slots", "slot", "slot machine", "s", "sm"):
        print("")
    ...
    if current_game in ("crash", "Crash", "C", "c"):
        print("")
    ...
    if current_game in ("horse race", "horse", "h", "H", "hr"):
        print("")
